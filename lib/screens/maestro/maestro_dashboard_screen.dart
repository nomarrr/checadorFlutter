...
class _MaestroDashboardScreenState extends State<MaestroDashboardScreen> {
  ...
  Map<int, AsistenciaMaestro?> _asistenciasHoy = {};
  ...
  Future<void> _registrarAsistencia(HorarioMaestro horario, TipoAsistencia tipo) async {
    final authProvider = Provider.of<AuthProvider>(context, listen: false);
    final user = authProvider.currentUser;
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  leading: CircleAvatar(
                                    backgroundColor: _getEstadoColor(tipoAsistencia),
                                    child: Icon(
                                  ...
                                  subtitle: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('Aula: ${horario.nombreAula} - ${horario.nombreEdificio}'),
                                      Text(
                                  ...
                                  trailing: asistencia == null
                                      ? ElevatedButton(
                                          onPressed: () => _mostrarOpcionesAsistencia(horario),
